...
export class SandboxService {
  ...
  private async assignWarmPoolSandbox(
    ...
    const sandbox = await this.sandboxRepository.update(warmPoolSandbox, updateData)
  ...
  async updatePublicStatus(sandboxIdOrName: string, isPublic: boolean, organizationId?: string): Promise<Sandbox> {
    ...
    return await this.sandboxRepository.update(sandbox, { public: isPublic })
  }
  ...
  async updateLastActivityAt(sandboxId: string, lastActivityAt: Date): Promise<Sandbox> {
    ...
    return await this.sandboxRepository.update(sandbox, { lastActivityAt })
  }
  ...
  async replaceLabels(
    ...
    // Replace all labels
    return await this.sandboxRepository.update(sandbox, { labels })
  }
  ...
  async setAutostopInterval(sandboxIdOrName: string, interval: number, organizationId?: string): Promise<Sandbox> {
    ...
    return await this.sandboxRepository.update(sandbox, {
  ...
  async setAutoDeleteInterval(sandboxIdOrName: string, interval: number, organizationId?: string): Promise<Sandbox> {
    ...
    return await this.sandboxRepository.update(sandbox, { autoDeleteInterval: interval })
  }
  ...
  async updateNetworkSettings(
    ...
    const updatedSandbox = await this.sandboxRepository.update(sandbox, updateData)
  ...
  async updateSandboxState(
    ...
    await this.sandboxRepository.update(sandbox, updateData)
  }
  ...
  async updateSandboxBackupState(
    ...
    return await this.sandboxRepository.update(sandboxToUpdate, updateData)
  }
}

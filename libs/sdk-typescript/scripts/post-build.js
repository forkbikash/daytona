...
const distDir = args[0] || path.join(__dirname, '../../../dist/libs/sdk-typescript')
const workspaceRoot = args[1] || path.join(__dirname, '../../..')
const sourceDir = args[2] || path.join(__dirname, '..')
